package proyecto.periodico.seguridad;
...
public class configuracionSeguridad {
	@Autowired
    private detallesUsuarioSevicio detallesUsu;
    ...
    DaoAuthenticationProvider authenticationProvider() {
	    ...
	    authProvider.setUserDetailsService(detallesUsu);
        ...
        http
            ...
            .formLogin(login ->
                login
                    ...
                    .defaultSuccessUrl("/auth/index", true) // Establece la URL de redirección después de un inicio de sesión exitoso.
